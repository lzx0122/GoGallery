...
// VerifyIDToken 驗證 Google ID Token 並回傳 sub/email/name/picture
func (s *GoogleAuthService) VerifyIDToken(token string, keys []map[string]interface{}) (string, string, string, string, error) {
